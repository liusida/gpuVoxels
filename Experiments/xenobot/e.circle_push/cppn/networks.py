...
from tools.utilities import neg_abs, neg_square, sqrt_abs, neg_sqrt_abs, normalize, sigmoid
...
class GeneralizedCPPN(CPPN):
    ...
    def __init__(self, output_node_names, include_default_inputs=False, **additional_inputs):
