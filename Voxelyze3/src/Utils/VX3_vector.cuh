...
template <typename T> class VX3_dVector_Larger; //If there will be more than 128 elements in the vector, we can use this vector class instead of VX3_dVector.
