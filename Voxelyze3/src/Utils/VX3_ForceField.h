...
struct VX3_ForceField {
    ...
    __device__ __host__ double x_forcefield(double x, double y, double z, double hit, double t, double angle, double closeness) {
        return VX3_MathTree::eval(x, y, z, hit, t, angle, closeness, token_x_forcefield);
    }
    __device__ __host__ double y_forcefield(double x, double y, double z, double hit, double t, double angle, double closeness) {
        return VX3_MathTree::eval(x, y, z, hit, t, angle, closeness, token_y_forcefield);
    }
    __device__ __host__ double z_forcefield(double x, double y, double z, double hit, double t, double angle, double closeness) {
        return VX3_MathTree::eval(x, y, z, hit, t, angle, closeness, token_z_forcefield);
    }
};
